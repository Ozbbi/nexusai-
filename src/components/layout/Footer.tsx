        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/50 mb-6">
              The marketplace for AI. Discover, buy, and sell AI models, agents, and tools.
            </p>
            <div className="flex gap-4">
              {["X", "GH", "DC"].map((icon) => (
                <span
                  key={icon}
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-xs text-white/50 hover:text-white transition-colors cursor-pointer"
                >
                  {icon}
                </span>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-primary w-48"
            />
